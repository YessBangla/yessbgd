...
function AwardsPage() {
  return (
    <>
      <PageHero eyebrow="Recognition" title="Awards, partnerships & certifications" subtitle="A snapshot of the recognition our team and partners have earned along the way." />
