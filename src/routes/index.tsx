          ...
          <div className="grid gap-6 lg:grid-cols-[1.2fr_2fr] lg:items-center">
            ...
            <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
              ...
              <a
                ...
                download
                aria-label="Download Yess Bangla Company Profile (DOCX, version 1.0, 17 pages, ~115 KB)"
                className="group relative flex h-full flex-col justify-between overflow-hidden rounded-2xl border border-primary/40 bg-background/70 p-5 backdrop-blur transition-all hover:-translate-y-1 hover:border-primary/60 hover:shadow-lg"
              >
                <div className="flex items-center justify-between">
                  <div className="grid h-10 w-10 place-items-center rounded-xl bg-gradient-primary text-primary-foreground shadow-glow">
                    <Download className="h-5 w-5" aria-hidden="true" />
                ...
                <div className="mt-6">
                  <div className="font-display text-base font-semibold">Company profile · DOCX</div>
                  <div className="mt-1 text-xs text-muted-foreground">
                    17 pages · ~115 KB · v1.0 · Generated 09 May 2026
                  </div>
                </div>
              </a>
            </div>
