...
SECTIONS = [
    {"n": "০১", "kicker": "ভূমিকা", "title": "ব্যবস্থাপনার পক্ষ থেকে বার্তা",
     "blocks": [
        ("p", "ইয়েস বাংলায় আমরা বিশ্বাস করি, আধুনিক বাংলাদেশ একটি আধুনিক এন্টারপ্রাইজ গ্রুপের যোগ্য — যা আন্তর্জাতিক ব্যবসায়িক শৃঙ্খলার সঙ্গে গভীর স্থানীয় অন্তর্দৃষ্টিকে একত্রিত করে। গত কয়েক বছরে আমরা সফটওয়্যার, স্যাটেলাইট টেলিভিশন, ওটিটি স্ট্রিমিং, ডিজিটাল সাংবাদিকতা, অর্গানিক বাণিজ্য, পেশাদার সেবা, হোস্টিং, ইভেন্ট, ট্যালেন্ট এবং খাদ্য খাত জুড়ে একগুচ্ছ পরিপূরক উদ্যোগ গড়ে তুলেছি — সবগুলোই আন্তর্জাতিক মানে পরিচালিত হয় এবং একই সাথে আমরা যেসব কমিউনিটিকে সেবা দিই, তাদের শিকড়ে গভীরভাবে প্রোথিত।"),
    ...
    {"n": "০২", "kicker": "গ্রুপ পরিচিতি", "title": "ইয়েস বাংলা সম্পর্কে",
     "blocks": [
        ("p", "ইয়েস বাংলা প্রাইভেট লিমিটেড একটি বাংলাদেশে নিবন্ধিত প্রাইভেট লিমিটেড কোম্পানি, যার সদর দপ্তর ঢাকার মিরপুরে অবস্থিত। গ্রুপটি চারটি কৌশলগত খাতে এগারোটি সম্পূর্ণ মালিকানাধীন ভেঞ্চার পরিচালনা করে: প্রযুক্তি, মিডিয়া ও ব্রডকাস্টিং, বাণিজ্য ও লাইফস্টাইল এবং পেশাদার সেবা।"),
        ...
        ("kv", [
            ...
            ("গ্রুপ ভেঞ্চার", "১১টি বিশেষায়িত ব্র্যান্ড"),
    ...
    {"n": "০৪", "kicker": "গ্রুপের কাঠামো", "title": "করপোরেট স্ট্রাকচার",
     "blocks": [
        ...
        ("table", {"head": ["খাত", "ভেঞ্চার", "ভূমিকা"], "rows": [
            ["প্রযুক্তি", "ইয়েস সফট · ইয়েস হোস্ট", "সফটওয়্যার ইঞ্জিনিয়ারিং, ওয়েব/মোবাইল, ইআরপি/সিআরএম, ক্লাউড হোস্টিং"],
            ["মিডিয়া ও ব্রডকাস্টিং", "আকাশ টিভি · আকাশ ওটিটি · দ্য ডেইলি আকাশ", "স্যাটেলাইট টিভি, ওটিটি স্ট্রিমিং, ডিজিটাল সংবাদপত্র"],
            ["বাণিজ্য ও লাইফস্টাইল", "ইয়েস অর্গানিক হাট · ইয়েস ফুড · ইয়েস মডেল", "অর্গানিক মার্কেটপ্লেস, খাদ্য, ট্যালেন্ট এজেন্সি"],
            ["পেশাদার সেবা", "ইয়েস সার্ভিস · ইয়েস ইভেন্ট · ইয়েস অল ইন ওয়ান", "হোম সার্ভিস, ইভেন্ট ম্যানেজমেন্ট, সমন্বিত সমাধান"],
        ]}),
     ]},
    {"n": "০৫", "kicker": "এগারো ব্র্যান্ড, এক গ্রুপ", "title": "ব্যবসায়িক বিভাগ ও ভেঞ্চার",
     "blocks": [
        ("p", "প্রতিটি ইয়েস বাংলা ভেঞ্চার একটি স্বতন্ত্র ব্র্যান্ড, যার নিজস্ব ক্লায়েন্ট, পণ্য ও রোডম্যাপ রয়েছে। একসঙ্গে এরা একটি সমন্বিত পোর্টফোলিও গঠন করে, যা প্রায় যেকোনো আধুনিক ব্যবসায়িক বা ভোক্তা প্রয়োজন মেটাতে সক্ষম।"),
        ("dl", [
            ...
            ("আকাশ টিভি — স্যাটেলাইট টেলিভিশন", "একটি শীর্ষস্থানীয় বাংলা ভাষার স্যাটেলাইট চ্যানেল, যা লক্ষ লক্ষ দর্শকের কাছে সংবাদ, বিনোদন, টক শো ও সাংস্কৃতিক অনুষ্ঠান পৌঁছে দেয়।"),
            ...
            ("ইয়েস সার্ভিস — হোম ও পেশাদার সেবা", "যাচাইকৃত ইলেকট্রিশিয়ান, প্লাম্বার, টেকনিশিয়ান, ক্লিনার ও টিউটরদের একটি অন-ডিম্যান্ড নেটওয়ার্ক, যা সেবার গ্যারান্টি ও ডিজিটাল বুকিং দ্বারা সমর্থিত।"),
    ...
    {"n": "০৬", "kicker": "আমরা যা সরবরাহ করি", "title": "সক্ষমতা ও সেবার পরিধি",
     "blocks": [
        ("dl", [
            ...
            ("ব্রডকাস্ট মিডিয়া", "স্যাটেলাইট টেলিভিশন প্রোডাকশন, সংবাদ বুলেটিন, টক শো, সাংস্কৃতিক অনুষ্ঠান এবং ব্রডকাস্ট বিজ্ঞাপন।"),
            ...
            ("পেশাদার সেবা", "অন-ডিম্যান্ড হোম ও ব্যবসায়িক সেবা, ইভেন্ট প্রোডাকশন, ট্যালেন্ট ম্যানেজমেন্ট এবং সমন্বিত ক্রস-ভেঞ্চার কর্মসূচি।"),
    ...
    {"n": "০৮", "kicker": "আমরা যাদের সেবা দিই", "title": "ক্লায়েন্ট, দর্শক ও বাজার ব্যাপ্তি",
     "blocks": [
        ...
        ("table", {"head": ["সেগমেন্ট", "উদাহরণ", "চুক্তি ধরন"], "rows": [
            ...
            ["ভোক্তা", "শহুরে ও আধা-শহুরে পরিবার", "টিভি, ওটিটি, সংবাদ, অর্গানিক পণ্য, সেবা"],
            ["বিজ্ঞাপনদাতা", "স্থানীয় ও বৈশ্বিক ব্র্যান্ড", "আকাশ টিভি / ওটিটি / ডেইলি আকাশে অন-এয়ার ও ডিজিটাল ইনভেন্টরি"],
        ]}),
     ]},
    {"n": "০৯", "kicker": "আমাদের যাত্রা", "title": "ট্র্যাক রেকর্ড ও মাইলফলক",
     "blocks": [
        ("dl", [
            ...
            ("মিডিয়া সম্প্রসারণ", "আকাশ টিভি স্যাটেলাইট চ্যানেল চালু হয়, এরপর আকাশ ওটিটি স্ট্রিমিং এবং দ্য ডেইলি আকাশ ডিজিটাল সংবাদপত্র।"),
            ("বাণিজ্য ও লাইফস্টাইল", "মানসম্পন্ন ভোক্তা পণ্য ও ট্যালেন্ট প্রতিনিধিত্ব আনতে ইয়েস অর্গানিক হাট, ইয়েস ফুড ও ইয়েস মডেল চালু হয়।"),
            ("সেবা নেটওয়ার্ক", "সারা বাংলাদেশে অন-ডিম্যান্ড পেশাদার সেবা সরবরাহের জন্য ইয়েস সার্ভিস, ইয়েস ইভেন্ট ও ইয়েস অল ইন ওয়ান চালু করা হয়।"),
    ...
    {"n": "১০", "kicker": "পরিচালনার মূলনীতি হিসেবে দায়িত্ব", "title": "করপোরেট সামাজিক দায়বদ্ধতা",
     "blocks": [
        ...
        ("dl", [
            ...
            ("জনস্বার্থ সাংবাদিকতা", "দ্য ডেইলি আকাশ ও আকাশ টিভি জাতীয় গুরুত্বের কম-প্রতিবেদনকৃত গল্পের জন্য সম্প্রচার সময় ও কলাম স্থান বরাদ্দ রাখে।"),
    ...
    {"n": "১২", "kicker": "আমাদের নেতৃত্ব", "title": "নেতৃত্ব দল",
     "blocks": [
        ...
        ("table", {"head": ["ভূমিকা", "দায়িত্ব"], "rows": [
            ...
            ["সম্পাদক-ইন-চিফ (মিডিয়া)", "আকাশ টিভি, ওটিটি ও ডেইলি আকাশ জুড়ে সম্পাদকীয় সততা"],
    ...
    {"n": "১৩", "kicker": "আমাদের পার্থক্য", "title": "কেন ইয়েস বাংলা",
     "blocks": [
        ("dl", [
            ("এক পার্টনার, বহু সক্ষমতা", "সফটওয়্যার, ব্রডকাস্ট, ওটিটি, সাংবাদিকতা, ই-কমার্স, হোস্টিং, সেবা ও ইভেন্ট — একটি ব্র্যান্ড ও চুক্তি কাঠামোর অধীনে।"),
